...
#             try:
#                 r_header, self.client_address = server_socket.recvfrom(self.buff_size)
#                 self.client_address = ("127.0.0.1", 62933)
#                 # print(f"{cp.RED}keep_alive_server:{cp.RESET} client address {self.client_address}")
#                 self.receive_queue.put(r_header)
#
#                 # print(f"{cp.PINK}keep_alive_server:{cp.RESET} going to manager: (((((((((((((((((((((((((((((((((((((((((((")
#                 r_header = self.receive_queue_manager(server_socket, True, FlagEnum.KA.value)
#                 # print(
#                 #     f"{cp.PINK}keep_alive_server:{cp.RESET} out of manager: (((((((((((((((((((((((((((((((((((((((((((")
#
#                 r_flag, r_frag_order, r_crc, r_data = self.menu.initialize_recv_header(r_header)
#                 # print(f"{cp.PINK}keep_alive_server:{cp.RESET} server KA: {r_flag} (((((((((((((((((((((((((((((((((((((((((((")
#
...
#                 print(f"{cp.MAGENTA}initialize_server_connection:{cp.RESET} Im in if not self.thread_ka:")
...
#             self.receive_queue.put(r_header)
#
#             print(f"{cp.MAGENTA}initialize_server_connection:{cp.RESET} going to manager: (((((((((((((((((((((((((((((((((((((((((((")
#             r_data = self.receive_queue_manager(server_socket, False, FlagEnum.INF.value)
#             print(f"{cp.MAGENTA}initialize_server_connection:{cp.RESET} data: {r_data}")
#             print(f"{cp.MAGENTA}initialize_server_connection:{cp.RESET} out of manager: (((((((((((((((((((((((((((((((((((((((((((")
#
...
#             # if server_socket:
#             #     server_socket.close()
#             print(f"{cp.RED}{cp.MAGENTA}initialize_server_connection:{cp.RESET} An error occurred: {e}. Try again.{cp.RESET}")
#
#     # def initialize_server_connection(self, server_socket: socket, sent_server_port: int = 0) -> int:
...
#             r_header = server_socket.recv(self.buff_size)
#             self.receive_queue.put(r_header)
#             print(f"{cp.OLIVE_GREEN}server_sender:{cp.RESET} Received {r_header}")
#
#             r_header = self.receive_queue_manager(server_socket, False)
#             r_flag, r_frag_order, r_crc, r_data = self.menu.initialize_recv_header(r_header)
#
...
#
#             # if self.is_KA(r_flag):
#             #     print(f"form sender Received KA")
#             #     server_socket.sendto(self.initialize_message(FlagEnum.ACK_KA.value, r_frag_order), self.client_address)
#
...
#
#     def receive_queue_manager(self, server_socket: socket, ka_flag: bool, flag: int = 7) -> bytes:
#         is_send = False
#         try:
#             while self.thread_on:
#                 try:
...
#                     r_flag = self.menu.get_flag(r_message)
#                     r_frag_order = self.menu.get_frag_order(r_message)
#
#                     # print(f"{cp.ORANGE}receive_queue_manager: r_flag: {r_flag} {cp.RESET}")
#
...
#                     server_socket.sendto(self.initialize_message(r_flag, r_frag_order, r_data, r_crc), self.server_address)
#                     is_send = True
#
#                 except queue.Empty:
